...
ARM Cortex-A 系列是 ARMv7-A 架构的应用处理器系列，涵盖 Cortex-A5、Cortex-A7、Cortex-A8、Cortex-A9、Cortex-A12、Cortex-A15 等多款处理器。

### 核心章节

1. **程序员模型** — 处理器模式（User/FIQ/IRQ/Supervisor/Abort/Undefined/System）、CPSR 标志位、备份寄存器（SPSR）
